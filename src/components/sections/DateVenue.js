...
export const DateVenue = () => {
  ...
  const generateCalendarLinks = useCallback(
    () => ({
      ...
      )}&location=${encodeURIComponent(eventDetails.location)}&sf=true`,
      ...
      yahoo: `https://calendar.yahoo.com/?v=60&title=${encodeURIComponent(
        ...
        eventDetails.description
      )}&in_loc=${encodeURIComponent(eventDetails.location)}&st=${
        eventDetails.startDate
    ...
    <section className="min-h-screen py-20 bg-gradient-to-b from-white via-rose-50 to-white">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="date-venue-item text-center mb-16">
          <h2 className="text-5xl font-serif text-gray-800 mb-3">
            Save the Date
          </h2>
