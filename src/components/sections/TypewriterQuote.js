...
export const TypewriterQuote = () => {
  ...
  return (
    <section className="flex flex-col lg:flex-row h-screen bg-gradient-to-br from-gray-50 to-gray-100 over">
      <div
        className="hidden lg:block lg:w-1/2 bg-cover bg-center bg-no-repeat bg-[url('/prewed-1.jpg')]"
      ></div>
              ...
              <div className="flex flex-col items-center ">
                ...
                <div className="relative min-h-[120px] flex items-center justify-center">
                  <h1 className="text-3xl md:text-4xl font-serif text-gray-800 leading-relaxed">
                    {text}
                    <span
                      className={`inline-block w-0.5 h-6 bg-gray-800 ml-1 -mb-1 transition-opacity duration-100 ${showCursor ? 'opacity-100' : 'opacity-0'
                        } hidden`}
                    />
                  </h1>
                </div>
                <div
                  className={`transform transition-all duration-1000 ${isTypingComplete
                ...
                >
                  <div className="h-10 w-10 mt-10 animate-bounce motion-safe duration-100 text-gray-700">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                      <path d="M26.29 20.29 18 28.59V0h-2v28.59l-8.29-8.3-1.42 1.42 10 10a1 1 0 0 0 1.41 0l10-10z" fill="currentColor" />
                    </svg>
                  </div>
                </div>
              </div>
